...
class ShirtColor extends StatefulWidget {
  @override
  _ShirtColorState createState() => _ShirtColorState();
}

class _ShirtColorState extends State<ShirtColor> {
  bool _red = false;
  bool _blue = false;
  bool _orange = false;
  bool _green = false;
  ...
  _fetchGetColor() async {
    ...
    var response =
        await http.post(getColorurl, body: {"id": userID, "type": "shirt"});
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary: Image.asset("images/shirts/Grey.png", width: 40),
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Black.png", width: 40),
                    onChanged: (bool value) {
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/White.png", width: 40),
                    onChanged: (bool value) {
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Light-Blue.png", width: 40),
                    onChanged: (bool value) {
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary: Image.asset("images/shirts/Blue.png", width: 40),
                    onChanged: (bool value) {
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Purple.png", width: 40),
                    onChanged: (bool value) {
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Orange.png", width: 40),
                    onChanged: (bool value) {
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary: Image.asset("images/shirts/Red.png", width: 40),
                    onChanged: (bool value) {
                      onChanged('Red', value);
                    }),
              ),
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary: Image.asset("images/shirts/Pink.png", width: 40),
                    onChanged: (bool value) {
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Yellow.png", width: 40),
                    onChanged: (bool value) {
            ...
            TableRow(children: [
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Light-Green.png", width: 40),
                    onChanged: (bool value) {
              ...
              TableCell(
                child: CheckboxListTile(
                    ...
                    secondary:
                        Image.asset("images/shirts/Green.png", width: 40),
                    onChanged: (bool value) {
  ...
  addTShirtColor() async {
    ...
    if (userID == null) {
      ...
      var response = await http.post(sellerColorurl,
          body: {"id": userID, "colors": holder_1.toString(), "type": "shirt"});
      print(response);
      if (response.statusCode == 200) {
